  ...
  return (
    ...
    <div className='w-full min-h-screen justify-center items-center flex'>
      ...
      action={func}>
        ...
        <button className='py-2 hover:cursor-pointer w-full text-xl font-bold rounded-md bg-linear-60 from-fuchsia-500 via-fuchsia-300 to-fuchsia-800 text-stone-100' type='submit'>Save</button>
      </form>
    </div>
    {data.success && (
        <div>
